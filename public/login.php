...
?>
  <form method="post"
   action="<?php  echo htmlspecialchars($_SERVER['PHP_SELF'])."?oauth_token=".$_GET['oauth_token'].'&oauth_callback='.urlencode($_GET['oauth_callback']); ?>">
      <!--."?oauth_token=".$_GET['oauth_token'].'&oauth_callback='.$_GET['oauth_callback'];-->
   <fieldset>
    <legend>Login</legend>
    <div>
